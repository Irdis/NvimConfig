...
vim.keymap.set('n', '<Leader>ld', ':G log -2000 --all --decorate --oneline --graph --pretty=\'%h · %aN %as · %B%-C() · %ar %d\'<CR>')
vim.keymap.set('n', '<Leader>lf', ':G log -2000 --all --decorate --oneline --graph --first-parent --pretty=\'%h · %aN %as · %B%-C() · %ar %d\'<CR>')
